...
class tx_metafeedit_grid {
	...
	/*
	    ...
	    */
		...
		//-----------------------------------------------------------------------------------------------------------------//
		// Récupération de la variable exporttype
		...
		switch ($exporttype)
		{
			...
			case "PDF":
			{
				...
				$taille = $taille / 10;   // pour avoir la taille totale des colonnes en millimètre
				...
				// titre de la page - Il est définit ici et non dans le header pour qu'il ne soit pas présent sur chaque page mais seulement la 1ère
				$titre =''; 
