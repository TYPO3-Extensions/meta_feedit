<?php
	...
	***************************************************************/
	 ...
	 * @version 0.24
	 */
	class tx_metafeedit_srfeuserregister_pi1_urlvalidator {
	...
	if (defined("TYPO3_MODE") && $TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/meta_feedit/class.tx_metafeedit_srfeuserregister_pi1_urlvalidator.php"]) {
		include_once($TYPO3_CONF_VARS[TYPO3_MODE]["XCLASS"]["ext/meta_feedit/class.tx_metafeedit_srfeuserregister_pi1_urlvalidator.php"]);
	}
