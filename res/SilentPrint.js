...
/**
 * Main function: Print silently on specific printer
 *
 * @param theDoc The event target of executing the menu item of this sample.
 */
function JSSilentPrintOnPrinter(theDoc,pname)
{
	// get the printParams object of the default printer
	var pp = theDoc.getPrintParams();
...
/**
 * Main function: Print silently on specific net printer
 *
 * @param theDoc The event target of executing the menu item of this sample.
 */
function JSSilentPrintOnNetPrinter(theDoc,pname,server)
{
	// get the printParams object of the default printer
	var pp = theDoc.getPrintParams();
