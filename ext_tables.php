...
$TCA["tx_metafeedit_actions"] = Array (
	"ctrl" => Array (
		"title" => "LLL:EXT:meta_feedit/locallang_db.xml:tx_metafeedit_actions",		
		"label" => "title",	
		"tstamp" => "tstamp",
		"crdate" => "crdate",
		"cruser_id" => "cruser_id",
...
t3lib_extMgm::addPlugin(Array("LLL:EXT:meta_feedit/locallang_db.xml:tt_content.list_type_pi1", $_EXTKEY."_pi1"),"list_type");
...
$TCA["tx_metafeedit_comments"] = Array (
	"ctrl" => Array (
		"title" => "LLL:EXT:meta_feedit/locallang_db.xml:tx_metafeedit_comments",		
		"label" => "entry",	
		"tstamp" => "tstamp",
		"crdate" => "crdate",
		"cruser_id" => "cruser_id",
