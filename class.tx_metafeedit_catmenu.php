...
***************************************************************/
/**
 * class.tx_metafeedit_catmenu.php
 *
...
class tx_metafeedit_catmenu extends tslib_pibase {
...
if (defined('TYPO3_MODE') && $TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/meta_feedit/class.tx_metafeedit_catmenu.php']) {
	include_once($TYPO3_CONF_VARS[TYPO3_MODE]['XCLASS']['ext/meta_feedit/class.tx_metafeedit_catmenu.php']);
}
